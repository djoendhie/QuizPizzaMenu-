...
class PizzaTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cellPizza", for: indexPath) as! TableViewCell
        
        cell.labelMenu.text = names[indexPath.row]
        cell.labelSpecials.text = specials[indexPath.row]
